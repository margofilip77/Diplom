            ...
            <div class="card shadow-sm" style="border-radius: 15px;">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item border-0">
                            <a href="{{ route('profile.bookings') }}" class="nav-link" style="color: #1A1A1A;">
                                <i class="fas fa-ticket-alt me-2"></i> Мої бронювання
                            </a>
                        </li>
                        <li class="list-group-item border-0">
                        ...
                        <li class="list-group-item border-0">
                            <a href="#support-messages" class="nav-link" data-bs-toggle="tab" style="color: #1A1A1A;">
                                <i class="fas fa-envelope me-2"></i> Повідомлення підтримки
                            </a>
                        </li>
                        <li class="list-group-item border-0">
            ...
            <div class="card shadow-sm" style="border-radius: 15px;">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <!-- Вкладка: Повідомлення підтримки -->
                        <div class="tab-pane fade" id="support-messages">
                            <h3 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Повідомлення підтримки</h3>
                            @if($messages->isEmpty())
                                <p>Ви ще не надсилали повідомлень до служби підтримки.</p>
                            @else
                                    ...
                                    <tbody>
                                        @foreach($messages as $message)
                                            <tr>
                                                ...
                                                <td>{{ $message->response ?? 'Відповідь ще не отримана' }}</td>
                                                <td>{{ $message->responded_at ? $message->responded_at->format('d.m.Y H:i') : '-' }}</td>
                                                <td>
                                                    <form action="{{ route('user.support-messages.delete', $message) }}" method="POST" style="display:inline;" onsubmit="return confirm('Ви впевнені, що хочете видалити це повідомлення?');">
                                                        @csrf
                                                        @method('DELETE')
